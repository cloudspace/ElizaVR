...
namespace IBM.Watson.DeveloperCloud.Services.SpeechToText.v1
{
    ...
    public class SpeechToText : IWatsonService
    {
		...
		public int PausesLimit { get { return m_PausesLimit; } set { m_PausesLimit = value; } }
        #endregion
...
//					UnityEngine.Debug.Log ("silence: "+silenceCounter+" pause: "+m_PausesLimit);

					if (silenceCounter > m_PausesLimit) {
						SendStop ();
						m_AudioSent = false;
					} 
//					else if (silenceCounter == m_PausesLimit - 1 && m_PausesLimit != 1) {
//						Cloudspace.EventController.main.animate (48, 0, 100, 0, 0.5);
//					} else {
//						Cloudspace.EventController.main.animate (48, 100, 0, 0, 0.5);
//					}
                ...
                {
					UnityEngine.Debug.Log ("SHIT DEAD YO");
...
//            m_ListenCallback = null;
        ...
        private void SendStop()
        {
            ...
            if (m_ListenActive)
            {
                ...
                stop["action"] = "stop";
				WSConnector.TextMessage stopMessage = new WSConnector.TextMessage (Json.Serialize (stop));
                m_ListenSocket.Send(stopMessage);
					...
					if (json.Contains("results"))
                    {
                        ...
                        if (results != null)
                        {
							if (newSpeech == true) {
								...
								Cloudspace.NotificationCenter.DefaultCenter ().PostNotification (null, "OnUserText", 
